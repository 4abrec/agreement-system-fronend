...
export class TokenService {
  ...
  public saveUserId(id: number) {
    window.sessionStorage.removeItem(CONSTANTS.USER_ID);
    window.sessionStorage.setItem(CONSTANTS.USER_ID, String(id));
  }
  ...
  public getUserId(): string | null {
    return sessionStorage.getItem(CONSTANTS.USER_ID);
  }
